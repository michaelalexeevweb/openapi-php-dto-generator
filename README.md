...
**2.10.0 → 2.11.0** adds one method and changes nothing else: generated output is byte-identical in all
three modes, and `DtoDeserializer::deserializeValue()` deserializes a single already-decoded JSON value so
